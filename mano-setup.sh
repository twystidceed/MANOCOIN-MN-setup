...
SOURCEA=https://github.com/MANOPlatform/manocoin/releases/download/v1.0.0/mano-1.0.0-x86_64-linux-gnu.tar.gz
...
#18.04
ARCHIVEA=mano-1.0.0-x86_64-linux-gnu.tar.gz
#16.04
ARCHIVEB=MANO_Ubuntu_16_04.tar.gz

#ADDNODES
ADDNODEA=85.241.252.143:12777
ADDNODEB=94.100.221.211:12777
ADDNODEC=157.52.211.5:12777

#name of the folder created with the git clone when clonign the repository
FOLDER=MANOCOIN-MN-setup
